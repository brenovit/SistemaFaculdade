...
public class InternalFrameCadastroAluno extends JInternalFrame {
	...
	public InternalFrameCadastroAluno() {
		setFrameIcon(new ImageIcon(InternalFrameCadastroAluno.class.getResource("/com/images/user32.png")));
		...
		btnCadastrar.setIcon(new ImageIcon(InternalFrameCadastroAluno.class.getResource("/com/images/useradd32.png")));
		...
		btnAtualizar.setIcon(new ImageIcon(InternalFrameCadastroAluno.class.getResource("/com/images/useredit32.png")));
		...
		btnExcluir.setIcon(new ImageIcon(InternalFrameCadastroAluno.class.getResource("/com/images/userremove32.png")));
		...
		btnConfirmar.setIcon(new ImageIcon(InternalFrameCadastroAluno.class.getResource("/com/images/userconfirm32.png")));
		...
		btnCancelar.setIcon(new ImageIcon(InternalFrameCadastroAluno.class.getResource("/com/images/usercancel32.png")));
		...
		btnPesquisar.setIcon(new ImageIcon(InternalFrameCadastroAluno.class.getResource("/com/images/usersearch32.png")));
